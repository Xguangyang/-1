...
namespace TMS.Repository.Personnel
{
    ...
    /// 入职办理
    /// </summary>
    public class HiredToHandlerRepository:IHiredToHandlerRepository
    {
        ...
        //小型工厂模式
        public HiredToHandlerRepository(IDapperFactory dapperFactory)
        {
        ...
        /// <param name="EntryTime">到岗日期</param>
        /// <param name="CreateTime">合同签署日期</param>
        ...
        public async Task<List<HiredToHandlerViewModel>> GetHiredToHandlerViewModels(string EmpName, string EmpDeparName, string PosterName, DateTime? EntryTime, DateTime? CreateTime, int ExamineStatus)
        {
            ...
            List<HiredToHandlerViewModel> data =await _SqlDB.QueryAsync<HiredToHandlerViewModel>(sql);
            //查询
